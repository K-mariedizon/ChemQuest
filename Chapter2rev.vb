...
Public Class Chapter2rev
    ...
    Private Sub Chapter2rev_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadContents()
        Try
            connection.Open()
            Dim query As String = "SELECT contents FROM Chapter2"
