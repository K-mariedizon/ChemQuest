...
Public Class Game1score
    ...
    Private Sub Game1score_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    ' Method to load high scores with filtering
    Private Sub LoadHighScores(remarksFilter As String)
        ' Query to select and filter data from HSMG1
        Dim query As String = "SELECT playDate, uScore, InScore, uTimer, remarks FROM HSMG1"
